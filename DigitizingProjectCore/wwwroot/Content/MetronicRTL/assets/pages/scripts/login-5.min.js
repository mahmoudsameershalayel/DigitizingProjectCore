        ...
        init: function () {
            r(), $(".login-bg").backstretch(
                ["/Content/MetronicRTL/assets/pages/img/login/bg1.jpg", "/Content/MetronicRTL/assets/pages/img/login/bg2.jpg",
                    "/Content/MetronicRTL/assets/pages/img/login/bg3.jpg"], { fade: 1e3, duration: 8e3 }), $(".forget-form").hide()
        }
    }
